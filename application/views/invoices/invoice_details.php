...
<div id="main_content_header">
	...
	<div style="float:right; width:25px;">
		...
		<img id="back" name="back" src="/images/back.png" title="Refresh Log" style="cursor:pointer; float:right; height:20px; padding-top:5px;" onclick="load_report()" />
	</div>
</div>
<div id="scrollable_content" class="scrollable_div">
	...
	<div style="padding:10px; margin-top:15px;">
		<span class="heading">Invoice Summary</span>
		<hr style="width:auto;">
		<br>
