<?php $attributes = array('name'=>'payable_account_form','id'=>'payable_account_form', )?>
<?=form_open('expenses/payable_account_selected',$attributes);?>
	<input type="hidden" id="allocated_expense_id" name="allocated_expense_id" value="<?=$expense["id"]?>" >
	<table style="margin-left:30px;">
		<tr>
			<td style="width:185px;">Invoice Payable Account</td>
			<td>
				<?php echo form_dropdown('payable_account_id',$payable_options,'Select','id="payable_account_id" onChange="payable_account_selected()" style="" class="left_bar_input"');?>
			</td>
		</tr>
	</table>
</form>
<div id="invoice_paid_form_div" name="invoice_paid_form_div" style="display:none; padding:10px; min-height:50px; margin-top:10px; margin-bottom:10px; background:rgb(221,221,221);">
	<!-- AJAX GOES HERE!-->
