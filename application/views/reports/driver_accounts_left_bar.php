...
<div id="filter_list" class="scrollable_div">
	...
	<?=form_open('reports/load_fuel_report',$attributes);?>
		...
		<hr/>
		<?php echo form_dropdown('fleet_managers_dropdown',$fleet_managers_dropdown_options,"Select",'id="fleet_managers_dropdown" style="" class="left_bar_input" onchange="load_driver_accounts()"');?>
		<br>
	</form>
</div>