...
<div id="main_content_header">
	<span style="font-weight:bold;">Current Bills</span>
	...
	<div id="expense_total" class="header_stats"  style="float:right; width:150px; margin-right:0px; font-weight:bold;"></div>
...
<table  style="table-layout:fixed; margin:5px; font-size:12px;">
	<tr class="heading" style="line-height:30px;">
		...
		<td style="width:80px;" VALIGN="top">Payer</td>
		<td style="width:80px; padding-left:5px;" VALIGN="top">Vendor</td>
		<td style="width:100px;" VALIGN="top">Invoice</td>
		<td style="width:110px; padding-left:10px;" VALIGN="top">Category</td>
		<td style="width:270px; padding-left:15px;" VALIGN="top">Description</td>
...
<div id="scrollable_content" class="scrollable_div">
	...
	<?php if(!empty($invoices)):?>
		<?php foreach($invoices as $invoice):?>
			<?php if((user_has_permission('view bills for assigned business') && user_is_assigned_to_business($invoice["business_id"])) || user_has_permission('view all bills')):?>
				<?php
					$row = $invoice["id"];
