...
<div id="main_content_header">
	...
	<img src="<?=base_url("images/edit.png")?>" style="cursor:pointer;float:right;margin-top:4px;height:20px; margin-left:10px;" id="edit_staff" onclick="load_staff_edit('<?=$company["id"]?>')" />
	<img src="<?=base_url("images/paper_clip2.png")?>" style="cursor:pointer;float:right;margin-right:10px;margin-top:2px;width:11px;" id="attachment_btn" onclick="open_file_upload(<?=$company["id"]?>,'staff')" />
...
<div id="scrollable_content"  class="scrollable_div">
	<div style="margin:20px;">
			...
			<table id="main_content_table" style="font-size:14px;">
				...
				<tr>
					...
					<?php if(!empty($spark_cc_account)):?>
						<td title="Account ID: <?=$spark_cc_account["id"]?>">
							<?=$company['spark_cc_number']?>
						</td>
					<?php else:?>
						<td>
							No CC Account
		...
		<div id="staff_attachments" style="margin-top:15px;">
