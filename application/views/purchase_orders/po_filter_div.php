...
<hr/>
<input type="text" id="search_term" name="search_term" class="left_bar_input" onchange="load_po_report()" onkeydown="Javascript: if (event.keyCode==13) load_po_report();" placeholder="PO Number">
<br>
<br>
...
?>
<?php echo form_dropdown('status_dropdown',$options,"Unapproved",'id="status_dropdown" onChange="load_po_report()" class="left_bar_input"');?>
