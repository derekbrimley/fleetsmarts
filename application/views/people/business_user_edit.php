<script>
	...
	function validate_save_business_user()
	{
	...
	function save_company()
	{
		//-------------- AJAX TO LOAD TRUCK DETAILS -------------------
			...
			// AJAX!
			$.ajax({
				url: "<?= base_url("index.php/people/save_business_user")?>", // in the quotation marks
				type: "POST",
				data: dataString,
				cache: false,
...
<div id="main_content_header">
	...
	<img src="<?=base_url("images/save.png")?>" style="margin-top:4px;cursor:pointer;float:right;height:20px;" id="save_staff" onclick="validate_save_business_user()"/>
	<img src="<?=base_url("images/back.png")?>" style="margin-top:4px;cursor:pointer;float:right;height:20px;margin-right:15px;" id="cancel_edit_staff" onclick="load_business_user_details('<?=$company["id"]?>')"/>
